...
export default function Hero(props) {
  ...
  return (
    <section className="container pt-4 xyz-in" xyz="fade down-50%">
      <div className="row align-items-center">
        ...
        <div className="col-6 pl-5">
          <div style={{ widows: 520, height: 410 }}>
            <img src={ImgHero} alt="Room with couches" className="img-fluid position-absolute" style={{ margin: '-30px 0 0 -30px', zIndex: 1 }} />
            <img src={ImgHeroFrame} alt="Room with couches frame" className="img-fluid position-absolute" style={{ margin: '0 -15px -15px 0' }} />
          </div>
        </div>
      </div>
    </section>
